                ...
                {["Sanchit Bhan", "Dheeraj Bhat"].map((name, idx) => (
                  ...
                  >
                    <div className="relative h-80">
                      <Image
                        src={["https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/team/ceo-sanchit.webp", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/team/cfo-dheeraj.webp"][idx]}
                        alt={name}
                        fill
                        className="object-cover"
                      />
