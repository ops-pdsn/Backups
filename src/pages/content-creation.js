...
const serviceBlocks = [
  {
    ...
    type: "video",
    media: ["https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/motion1.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/motion2.webm"]
  },
  {
    ...
    type: "video",
    media: ["https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/2Danimation.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/3Danimation3.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/3Danimation.webm"]
  },
  {
    title: "CGI Content",
    icon: "🎨",
    ...
    type: "video",
    media: ["https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/cgi1.webp", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/cgi1.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/cgi2.webp"]
  },
  {
    ...
    type: "video",
    media: ["https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/anamorphic3.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/anamorphic2.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/anamorphic1.webm"]
  },
  {
    ...
    type: "video",
    media: ["https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/productapp1.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/productapp2.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/productapp3.webm"]
  },
  {
    ...
    type: "video",
    media: ["https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/digigreeting1.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/digigreeting2.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/digigreeting3.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/digigreeting4.webm"]
  },
  {
    ...
    type: "video",
    media: ["https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/corporate1.webm", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/videos/corporate2.webm"]
  },
  {
    ...
    type: "image",
    media: ["https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/product1.webp", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/product2.webp", "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/product3.webp"]
  }
];
                ...
                {service.media.map((src, i) => (
                  <div key={i} className="relative rounded-xl overflow-hidden shadow-md">
                    <Suspense fallback={<div className="p-4 text-center">Loading...</div>}>
                      {src.endsWith('.webm') ? (
                        <LazyVideo src={src} aspect={service.title === "Digi-Greetings" ? "square" : "video"} poster="https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/poster-placeholder.webp" />
                      ) : (
                        <Image
                          src={src}
                          alt={service.title}
                          ...
                          decoding="async"
                          placeholder="blur"
                          blurDataURL="https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/placeholder.webp"
                        />
                      )}
                    </Suspense>
                    ...
                    {['model1.glb', 'model2.glb'].map((model, i) => (
                      <div key={i} className="relative w-full h-[400px] sm:h-[500px] bg-[#181a2a] rounded-xl shadow-md">
                        <Suspense fallback={<div className="flex items-center justify-center h-full">
                          ...
                          <ThreeDViewer modelUrl={`https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/assets/models/${model}`} />
                        </Suspense>
                      </div>
                    ))}
                  </div>
