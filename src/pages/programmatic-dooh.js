      ...
      <main className="bg-white text-black">
        ...
        <section className="py-20 px-6 bg-gray-100">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                { label: "CORPORATE", image: "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/coporate1.webp", objectPosition: "object-top" },
                { label: "CAFES", image: "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/image (9).webp", objectPosition: "[object-position:50%_50%]" },
                { label: "OUTDOOR", image: "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/outdoor2.webp", objectPosition: "object-bottom" },
                { label: "TRANSIT", image: "https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/image (12).webp", objectPosition: "[object-position:70%_30%]" }, // custom
              ].map((item, idx) => (
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10">
            ...
            <div>
              <Image
                src="https://cdn.jsdelivr.net/gh/ops-pdsn/cdn-assets@main/images/programmatic-benefits.webp"
                alt="DOOH Benefits"
                width={500}
                height={350}
